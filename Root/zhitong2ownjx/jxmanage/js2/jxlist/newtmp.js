$(function () {
   ...
   //var url = "http://forchild.zhitong.group";
    ...
    $(document).on('click','.edittmp-add',function(){
        ...
        var html = "<tr><td><textarea></textarea><button class='btn"+k+"'>因子库</button></td><td><input class='score' type='text' value='' placeholder=''></td><td class='delete'><span>删除</span></td></tr>"
...
//添加项目
    ...
    $(document).on('click','.additem',function(){
        ...
        var html = "<tbody class='num"+k+"'>"+
            "<tr><td rowspan='1000'><input type='text' class='typeName' value=''placeholder='项目名称'><div class='edittmp-per'><input type='text' value=''><span>%</span><i class='deleteitem  glyphicon glyphicon-remove' style='display: block;margin-top: 20px'></i></div></td></tr>"+
