                            ...
                            if(group[0].groupName==""){
                               var status = Number(0);
                                ...
                                for(var i = 0;i<grouplen;i++){
                                    html+="<option class='num"+group[i].achConfigId+"' achConfigId='"+group[i].achConfigId+"'>"+group[i].groupName+"</option>";
                                }
                                ...
                                var isusearr = [];
                                var data2 = {};
                                data2.gartenId = gartenId;
                                var datas2 = JSON.stringify(data)
                                $.ajax({
                                    url:""+url+"/meritpay/template/get",
                                    type:'post',
                                    async: false,
                                    ...
                                    success:function(res){
                                        ...
                                        for(var i = 0;i<len;i++){
                                            if(res.data[i].achConfigId !==""){
                                                isusearr.push(res.data[i].achConfigId)
                                            }
                                        }
                                        console.log(res)
                                    }
                                ...
                                for(var j = 0;j<isusearr.length;j++){
                                    $(".selgroup .num"+isusearr[j]+"").attr("disabled","disabled");
                                    $(".selgroup .num"+isusearr[j]+"").css("background","#D8D8D8");
                                }
